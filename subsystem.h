...
enum{SYS_EV_1=(1<<0),SYS_EV_2=(2<<0),SYS_EV_3=(3<<0),SYS_EV_4=(4<<0),SYS_EV_5=(5<<0),SYS_EV_6=(6<<0),SYS_EV_7=(7<<0),SYS_EV_8=(8<<0)};  // These are events in SYS_evt, add more as necessary 
#define SYS_EVT_ALL (SYS_EV_1|SYS_EV_2|SYS_EV_3|SYS_EV_4|SYS_EV_5|SYS_EV_6|SYS_EV_7|SYS_EV_8)

enum{SD_EV_WRITE_1=(1<<0),SD_EV_WRITE_2=(2<<0),SD_EV_DIE=(3<<0),SD_EV_FINISHED=(4<<0)};//these are the memory card events 
